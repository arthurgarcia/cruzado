...
For linux (including ARM) cross compilation:

    sudo apt-get install curl g++-aarch64-linux-gnu g++-4.8-aarch64-linux-gnu gcc-4.8-aarch64-linux-gnu binutils-aarch64-linux-gnu g++-4.8-multilib gcc-4.8-multilib binutils-gold bsdmainutils
...
The following can be set when running make: make FOO=crz
    ...
    NO_GTEST: Don't download/build/cache gtest and its dependencies
