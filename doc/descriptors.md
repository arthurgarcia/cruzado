# Support for Output Descriptors in cruZado Core

Since cruZado Core v2.17, there is support for Output Descriptors in the
...
- `multi(1,022f8bde4d1a07209355b4a7250a5c5128e88b84bddc619ab7cba8d569b240efe4,025cbdf0646e5db4eaa398f365f2ea7a0e3d419b7e0330e39ce92bddedcac4f9bc)` describes a crze *1-of-2* multisig output with keys in the specified order.
...
- Segwit addresses (bech32, of the form `crz1...`, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on cruZado's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing cruZado Core wallets, a convenience function `combo` is
