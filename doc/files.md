...
* cruzado.conf: contains configuration settings for cruzadod or cruzado-qt
* cruzadod.pid: stores the process id of cruzadod while running
...
* debug.log: contains debug information and general logging generated by cruzadod or cruzado-qt
* fee_estimates.dat: stores statistics used to estimate minimum transaction fees and priorities required for confirmation; since 0.10.0
* indexes/txindex/*: optional transaction index database (LevelDB); since 2.17.0
