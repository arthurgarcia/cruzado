...
space *do not upload these to the cruzado.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the cruzado.org server.

```
- Update cruzado.org version

- Announce the release:

  - cruzado-dev and cruzado-dev mailing list

  - blog.cruzado.org blog post
