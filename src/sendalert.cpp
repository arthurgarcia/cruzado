...
./cruzadod -printtoconsole -sendalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusCrz  = "Your client is out of date and incompatible with the Sapling network upgrade. Please update to a recent version of cruZado (2.0.0 or later).";
    alert.strRPCError   = alert.strStatusCrz;
    ...
    assert(alert.strStatusCrz.length() <= 256);
