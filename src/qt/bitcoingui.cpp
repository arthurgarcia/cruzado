    ...
    platformStyle(platformStyle)
{
    ...
    // Create actions for the toolcrz, menu crz and tray/dock icon
...
void BitcoinGUI::createActions()
{
    ...
    addressBookAction->setStatusTip(tr("View and manage the cruZado address book"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a cruZado address using transparent transactions"));
    ...
    sendZCoinsAction->setStatusTip(tr("Send coins to a cruZado address using private transacions"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cruzado: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your cruZado addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->MultiColorIcon(":/images/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified cruZado addresses"));
    ...
    openAction->setStatusTip(tr("Open a cruzado: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->MultiColorIcon(":/images/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible cruZado command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::createToolCrzs()
{
    if(walletFrame)
    {
        ...
        toolcrz->addAction(overviewAction);
        toolcrz->addAction(addressBookAction);
        toolcrz->addAction(sendCoinsAction);
        toolcrz->addAction(sendZCoinsAction);
        toolcrz->addAction(receiveCoinsAction);
        toolcrz->addAction(historyAction);
        toolcrz->addSeparator();
        toolcrz->addAction(backupWalletAction);
        toolcrz->addAction(optionsAction);
        toolcrz->addSeparator();
        toolcrz->addAction(aboutAction);
        toolcrz->addSeparator();
        toolcrz->addAction(quitAction);
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setPixmap(platformStyle->MultiColorIcon(icon).pixmap(STATUSCRZ_ICONSIZE,STATUSCRZ_ICONSIZE));
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to cruZado network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate)
{
    ...
    if(secs < 90*60)
    {
        ...
        labelBlocksIcon->setPixmap(platformStyle->MultiColorIcon(":/images/synced").pixmap(STATUSCRZ_ICONSIZE, STATUSCRZ_ICONSIZE));
    ...
    else
    {
        ...
        if(count != prevBlocks)
        {
            labelBlocksIcon->setPixmap(platformStyle->MultiColorIcon(QString(
                ...
                .pixmap(STATUSCRZ_ICONSIZE, STATUSCRZ_ICONSIZE));
...
{
    QString strTitle = tr("cruZado"); // default title
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setPixmap(platformStyle->SingleColorIcon(":/icons/lock_open").pixmap(STATUSCRZ_ICONSIZE,STATUSCRZ_ICONSIZE));
    ...
    case WalletModel::Locked:
        labelEncryptionIcon->show();
        labelEncryptionIcon->setPixmap(platformStyle->SingleColorIcon(":/icons/lock_closed").pixmap(STATUSCRZ_ICONSIZE,STATUSCRZ_ICONSIZE));
