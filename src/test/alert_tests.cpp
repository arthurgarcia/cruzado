...
void GenerateAlertTests()
{
    ...
    alert.strStatusCrz  = "Alert 1 for MagicBean 0.1.0";
    SignAndSerialize(alert, sBuffer);

    alert.setSubVer.insert(std::string("/MagicBean:0.2.0/"));
    alert.strStatusCrz  = "Alert 1 for MagicBean 0.1.0, 0.2.0";
    SignAndSerialize(alert, sBuffer);
    ...
    alert.nCancel = 1;
    alert.nPriority = 100;
    alert.strStatusCrz  = "Alert 2, cancels 1";
    SignAndSerialize(alert, sBuffer);
    ...
    alert.strStatusCrz  = "Alert 3, disables RPC";
    alert.strRPCError = "RPC disabled";
    SignAndSerialize(alert, sBuffer);

    ++alert.nID;
    alert.nPriority = 5000;
    alert.strStatusCrz  = "Alert 4, re-enables RPC";
    alert.strRPCError = "";
    SignAndSerialize(alert, sBuffer);
    ...
    ++alert.nID;
    alert.strStatusCrz  = "Alert 2 for MagicBean 0.1.0";
    alert.setSubVer.insert(std::string("/MagicBean:0.1.0/"));
    SignAndSerialize(alert, sBuffer);
    ...
    alert.strStatusCrz  = "Evil Alert'; /bin/ls; echo '";
    alert.setSubVer.clear();
