...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cruzado-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cruzado-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cruzado transaction") + "\n" +
              "  cruzado-tx [options] -create [commands]   " + _("Create hex-encoded cruzado transaction") + "\n" +
              "\n";
