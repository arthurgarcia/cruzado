...
if [[ "$OSTYPE" == "darwin"* ]]; then
    PARAMS_DIR="$HOME/Library/Application Support/cruZadoParams"
else
    PARAMS_DIR="$HOME/.cruzado-params"
fi
...
Failed to fetch the cruZado zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
cruZado - fetch-params.sh

This script will fetch the cruZado zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common cruZado zkSNARK parameters. Note that it is
